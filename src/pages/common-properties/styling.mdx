...
Again, you can refer to the test harness <a href="https://github.com/elyra-ai/canvas/blob/main/canvas_modules/harness/src/styles/index.scss">index.scss</a> file for sample code.
